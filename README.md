...
### Repository 
The folder "**src**" contains the code to run. "**plots**" contains the resulting plot. 'Masterproef_Maren_Vranckx.pdf' is the reference to the Polonium problem. 'Theoretical and Numerical Aspects of NP - Project.pdf' is a brief presentation of the whole project.
